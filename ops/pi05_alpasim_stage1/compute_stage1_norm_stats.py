...
def compute_stage1_norm_stats(
    *,
    ...
    config = make_stage1_train_config(
        repo_id=repo_id,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compute norm stats for the Stage 1 pi05 driving dataset.")
    parser.add_argument("--repo-id", default="local/stage1_av_driving")
    ...
    output = compute_stage1_norm_stats(
